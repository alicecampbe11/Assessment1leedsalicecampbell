...
"""
    ...
    Animation/Behaviour (A:B) practical. 
    
    This practical edits an imported 
    animated model file and refines the previously existing code using it. 
    Output of the code is an animated graphic.
